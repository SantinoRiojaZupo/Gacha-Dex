...
<head>
    ...
    <title>Emiliano | Portafolio</title>
    <link rel="stylesheet" href="../CSS/estiloCreadores.css">
</head>
...
<body>
    ...
    <div class="card" style="max-width:400px;margin:80px auto 40px auto;">
        <img src="../imagenes/emiliano.png" alt="Foto de Emiliano"
            style="width:100%;height:340px;object-fit:cover;border-radius:10px 10px 0 0;">
        <h2>Emiliano Estrada</h2>
        <p>Roles:Programator</p>
        <p>Description: He has a passion for programming, doing conecctions and teamwork.He is in charge of the
            developement of the project Gacha-Dex.</p>
        <div style="margin-top:15px;">
            <a href="https://github.com/emiliano-estra" target="_blank" class="btn-link">GitHub</a>
            <a href="mailto:emilianoestrada278@gmail.com" class="btn-link">Email:emilianoestrada278@gmail.com</a>
            <a href="https://www.linkedin.com/in/emiliano-angel-estrada/" target="_blank"
