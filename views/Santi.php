...
<head>
    ...
    <title>Santino | Portafolio</title>
...
<body>
    ...
    <div class="card" style="max-width:400px;margin:80px auto 40px auto;">
        <img src="../imagenes/Santi.png" alt="Foto de Santi"
            style="width:100%;height:340px;object-fit:cover;border-radius:10px 10px 0 0;">
        <h2>Santino Rioja Zupo</h2>
        <p>Roles:Second Scrum Master, Programer, DataBaseDesigner</p>
        ...
        <div style="margin-top:15px;">
            <a href="https://github.com/SantinoRiojaZupo" target="_blank" class="btn-link">GitHub</a>
            <a href="mailto:santinoriojazupo@gmail.com" class="btn-link">Email:santinoriojazupo@gmail.com</a>
